...
_SCHABLONEN: dict[int, list[tuple[str, ...]]] = {
    # Je Ziffer: zuerst die Pruefschrift aus tests/fixtures/aip/blatt_bauen.py,
    # dann die DFS-Formen. Letztere sind NICHT von Hand geraten, sondern automatisch
    # beschriftet: Die Gradzahl ueber einem Tick MUSS die Gradzahl des Flugplatzes
    # sein, und der steht in airportsdata. Gewonnen ueber 110 Blaetter mit
    # scripts/aip_schablonen.py; aufgenommen nur Formen mit mindestens drei
    # Vorkommen, alles darunter ist Rauschen.
    0: [('#####', '#...#', '#...#', '#...#', '#...#', '#...#', '#...#', '#...#', '#####'),
        ('..##..', '.#..#.', '.#..#.', '.#..##', '##..##', '##..##', '##..##', '.#..#.', '.#..#.', '.####.'),
        ('.###.', '##.##', '#...#', '#...#', '#...#', '#...#', '#...#', '#...#', '.#..#', '.###.'),
        ('.###.', '#..#.', '#...#', '#...#', '#...#', '#...#', '#...#', '#...#', '#..#.', '.###.'),
...
# **Bekannte Luecke:** Fuer die 6 steht nur die Pruefschrift. Sie kommt in deutschen
# Gradzahlen (Breite 47-55, Laenge 5-15) nicht vor und liess sich deshalb nicht
# automatisch beschriften. Eine Minute mit einer 6 gilt als unlesbar, die Stuetzstelle
# faellt weg -- bei drei und mehr Ticks je Achse bleibt das meist verkraftbar.
