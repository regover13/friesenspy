...
_SCHABLONEN: dict[int, list[tuple[str, ...]]] = {
    ...
    # DFS-Formen. Letztere sind NICHT nach Augenschein zugeordnet, sondern automatisch
    # beschriftet: Die Gradzahl ueber einem Tick MUSS die Gradzahl des Flugplatzes sein,
    # und die steht in airportsdata. Gewonnen ueber 369 Blaetter; aufgenommen sind Formen
    # mit mindestens zwei Vorkommen, alles darunter ist Rauschen.
    0: [('#####', '#...#', '#...#', '#...#', '#...#', '#...#', '#...#', '#...#', '#####'),
        ('.###.', '##.##', '#...#', '#...#', '#...#', '#...#', '#...#', '#...#', '.#..#', '.###.'),
        ('.###.', '#..#.', '#...#', '#...#', '#...#', '#...#', '#...#', '#...#', '#..#.', '.###.'),
        ('.###.', '#..#.', '#..#.', '#..##', '#...#', '#...#', '#..##', '#..#.', '#..#.', '.##..'),
