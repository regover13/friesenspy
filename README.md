...
- **Verschiedene Waren je Startplatz (optional):** Eine Frachtart kann an einen **Startplatz** gebunden werden — dann lädt sie nur, wer dort startet (z.B. *ab EDDW Äpfel, ab EDWG Birnen*, alle zum selben Ziel). So steht die Ware durch den Startort fest, statt sich über die Abflugreihenfolge zu verschieben. Ohne Bindung bleibt eine Frachtart geteilt (von jedem Startplatz ladbar) — das bisherige Verhalten. Der Fortschritt wird dann **je Startplatz gruppiert** angezeigt, mit einem Gesamt-Balken darüber.
