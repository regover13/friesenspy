...
- **Im Kniebrett kommt Türkis von deinem eigenen Simulator.** Dort braucht es keine fremde Meldung: Der Simulator zeigt dir die Flugzeuge um dich herum ohnehin, und sobald das Kniebrett eines davon einem Piloten zuordnen kann, wird es türkis. Das ist die genaueste Anzeige, die es in FriesenSpy gibt — gemessen statt geschätzt, ohne einen einzigen Netzweg dazwischen. **Auch der Fremdverkehr zeigt es an**, dort aber anders: Sein Symbol bleibt dunkel, nur sein Saum wird türkis. Die Fläche eines Flugzeugs sagt weiterhin, ob es ein Friese ist — daran ändert die Quelle nichts. Verliert der Simulator ein Flugzeug aus den Augen, fällt es wieder auf VATSIM zurück
