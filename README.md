...
Auch ein **FriesenFliegerBummel** ist teilbar: im enthüllten Ranking öffnet der **🔗 Teilen**-Knopf am Handy das native Teilen-Menü (sonst landet der Link in der Zwischenablage). Der Link (`#tab=events&bummel=<id>`) öffnet beim Empfänger direkt dieses Ranking.
